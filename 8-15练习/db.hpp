...
#define MYSQL_HOSE "192.168.43.43"
...
namespace image_server
{
    ...
    static MYSQL* MysqlInit()
    {
        ...
        if(mysql_real_connect(mysql, MYSQL_HOSE, MYSQL_USER, MYSQL_PSWD, MYSQL_NAME, 0, NULL, 0))
        {
    ...
    class TableImage
    {
        ...
        public:
            ...
            {
                #define IMAGE_GETONE "select * from table_image where if = %d;"
                char sql[4096] = {0};
